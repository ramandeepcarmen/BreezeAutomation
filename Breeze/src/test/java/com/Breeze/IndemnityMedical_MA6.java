...
public class IndemnityMedical_MA6 extends BaseTest{
	
	@Test(priority=0)
    public void IndemnityMedical_MA6_Claim() 
    {   
	    ...
	    try 
	    {
	    	...
	    	ncs.ClickTextName1("li", "Massachusetts");
	    	TestListener.test.log(Status.PASS, "Verified that Jurisdiction dropdown is available and user selected the value 'Massachusetts' from dropdown");
	    	...
	    	ncs.sendKeys(ncs.SearchField, "WC500-0073247-2019A");
	    	po.screenShotPass("User entereded the Policy Number 'WC500-0073247-2019A' in a search text field");
			...
			{				
				...
				Assert.assertTrue(PolicyNumber.contains("WC500-0073247-2019A"));
