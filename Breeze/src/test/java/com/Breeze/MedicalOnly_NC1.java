...
public class MedicalOnly_NC1 extends BaseTest{
	
	@Test(priority=0)
    public void MedicalOnly_NC1_Claim() 
    {   
	    ...
	    try 
	    {
	    	...
	    	ncs.ClickTextName1("li", "North Carolina");
	    	TestListener.test.log(Status.PASS, "Verified that Jurisdiction dropdown is available and user selected the value 'North Carolina' from dropdown");
	    	...
	    	ncs.sendKeys(ncs.SearchField, "WC100-0080177-2020A");
	    	po.screenShotPass("User entereded the Policy Number 'WC100-0080177-2020A' in a search text field");
			...
			{				
				...
				Assert.assertTrue(PolicyNumber.contains("WC100-0080177-2020A"));
