...
public class IndemnityMedical_VA4 extends BaseTest{
	
	@Test(priority=0)
    public void IndemnityMedical_VA4_Claim() 
    {   
	    ...
	    try 
	    {
	    	...
	    	ncs.ClickTextName1("li", "Virginia");
	    	TestListener.test.log(Status.PASS, "Verified that Jurisdiction dropdown is available and user selected the value 'Virginia' from dropdown");
	    	...
	    	ncs.sendKeys(ncs.SearchField, "WC100-0090069-2020A");
	    	po.screenShotPass("User entereded the Policy Number 'WC100-0090069-2020A' in a search text field");
			...
			{				
				...
				Assert.assertTrue(PolicyNumber.contains("WC100-0090069-2020A"));
			...
			ncs.sendKeys(ncs.PayPeriodFromDate, todayDate+"2020");
			ncs.click(ncs.IndemnitySchedulePayDate);
			Thread.sleep(1000);
			ncs.sendKeys(ncs.PayPeriodToDate, todayDate+"2020");
			ncs.click(ncs.IndemnitySchedulePayDate);
			Thread.sleep(1000);
			...
			ncs.click(ncs.IndemnitySchedulePayDate);
			Thread.sleep(1000);
			ncs.sendKeys(ncs.IndemnitySchedulePayDate, todayDate+"2020");
			...
			Thread.sleep(2000);
			ncs.ClickTextName1("span", "381 Deerfield");
	    	...
	    	Assert.assertTrue(ncs.CheckPrintSuccessMessage.isDisplayed());
	    	Assert.assertTrue(AlertText20.contains("Checks printed and batch was automatically posted") || AlertText2.contains("Successfully submitted \"Print Checks\""));
	    	po.screenShotPass("'Checks printed and batch was automatically posted.' message appears at bottom of screen on clicking 'Check Print' button");
