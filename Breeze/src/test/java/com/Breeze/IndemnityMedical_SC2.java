...
public class IndemnityMedical_SC2 extends BaseTest{
	
	@Test(priority=0)
    public void IndemnityMedical_SC2_Claim() 
    {   
	    ...
	    try 
	    {
	    	...
	    	ncs.ClickTextName1("li", "South Carolina");
	    	TestListener.test.log(Status.PASS, "Verified that Jurisdiction dropdown is available and user selected the value 'South Carolina' from dropdown");
	    	...
	    	ncs.sendKeys(ncs.SearchField, "WC100-0080791-2020A");
	    	po.screenShotPass("User entereded the Policy Number 'WC100-0080791-2020A' in a search text field");
			...
			{				
				...
				Assert.assertTrue(PolicyNumber.contains("WC100-0080791-2020A"));
